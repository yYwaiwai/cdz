...
@interface PositionErrorCorrectionVC ()<BMKMapViewDelegate, BMKLocationServiceDelegate, BMKGeoCodeSearchDelegate, BMKPoiSearchDelegate, DZNEmptyDataSetSource, DZNEmptyDataSetDelegate, UISearchBarDelegate, UITableViewDelegate, UITableViewDataSource>
...
@implementation PositionErrorCorrectionVC
...
- (IBAction)locateCurrentView {
    if (self.latitude!=nil||self.latitude!=nil) {
        self.userCurrentCoordinate=CLLocationCoordinate2DMake(self.latitude.doubleValue,self.longitude.doubleValue);
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.searchBarWasFirstResponder) {
        ...
        _selectedPointInfo=self.addressNearbyPoiList[indexPath.row];
