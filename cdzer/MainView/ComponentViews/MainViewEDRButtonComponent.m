...
@interface MainViewEDRButtonComponent ()
...
@implementation MainViewEDRButtonComponent
...
- (void)awakeFromNib {
    @autoreleasepool {
        ...
        for (int i = 1; i<20; i++) {
            NSString *imageName = [NSString stringWithFormat:@"EDR_icon_list_%02d@3x", i];
            UIImage *image = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:imageName ofType:@"png"]];
            [imagesList addObject:image];
        }
        
        self.imageView.image = [UIImage animatedImageWithImages:imagesList duration:6];
        
        UITapGestureRecognizer *tapGestureRecognizer = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(pushToEDRMain)];
